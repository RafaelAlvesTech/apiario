...
medida_entrada = input(
    "Digite a medida ATUAL qual a quantidade se refere pode ser: (cm, m, km, pe, polegadas, jarda, milha.): "
)
medida_saida = input(
    "Digite a medida para qual deseja Converter : (cm, m, km, pe, polegadas, jarda, milha.): "
)
