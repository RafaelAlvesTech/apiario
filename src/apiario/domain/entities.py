from dataclasses import (
    dataclass,
    field,
)  # estude field muda a forma que o dataclass verifica os campos, seria um classe especifica para dados.
...
@dataclass(
    kw_only=True
)  # init, repr, eq(compraração), order e hash cria construtor tipado e outros métodos mágicos. Estude também namedtuples.
class Apiario:
    ...
    )  # estude default_factory, lambda e datetime. Ponto importante pra testes. funçãpo para gerar uma data nova em tempo de excução
